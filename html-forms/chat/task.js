...
const boxOfAnswers = ['Добрый день! Точно добрый !?',
                      'Конкретнее выражайтесь', 
                      'Ой, лучше переведу на специалиста...',
                      'Попробуйте писать понятнее',
                      'Звучит несколько сложно',
                      'Доброе утро, да кто в такую рань пишет??',
                      'Проверяю...',
                      'Сейчас все специалисты заняты. Но мы когда-то с вам свяжемся',
                      'К сожалению, этого товара у нас нет в наличии', 
                      'Для продолжения нажмите Alt+F4', 
                      'В данный момент все специалисты заняты чем-то более интересным, мы вам обязательно напишем'
                    ];
